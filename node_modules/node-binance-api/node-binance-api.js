...
LIMIT_MAKER
	...
	return {
		...
		price: function(symbol, callback) {
			publicRequest(base+'v3/ticker/price', {symbol:symbol}, callback);
		},
		...
		bookTicker: function(symbol, callback) {
			publicRequest(base+'v3/ticker/bookTicker', {symbol:symbol}, callback);
		},
